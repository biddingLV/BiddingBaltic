...
namespace Bidding.Migrations
{
    ...
    [Migration("20190612140859_PopulateUsersTableWithAdmins")]
    partial class PopulateUsersTableWithAdmins
    {
            ...
            modelBuilder.Entity("Bidding.Database.DatabaseModels.Auctions.Details.ItemAuctionDetails", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastUpdatedAt = new DateTime(2019, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LastUpdatedBy = 1,
                            ManufacturingDate = new DateTime(2019, 6, 12, 14, 8, 58, 778, DateTimeKind.Utc).AddTicks(8157),
                            Model = "In progress"
                        });
                });
            ...
            modelBuilder.Entity("Bidding.Database.DatabaseModels.Auctions.Details.VehicleAuctionDetails", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastUpdatedBy = 1,
                            Make = "In progress",
                            ManufacturingDate = new DateTime(2019, 6, 12, 14, 8, 58, 780, DateTimeKind.Utc).AddTicks(2011),
                            Model = "In progress"
                        });
                });
