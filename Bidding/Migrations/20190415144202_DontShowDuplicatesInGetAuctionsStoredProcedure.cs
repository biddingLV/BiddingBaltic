...
{
    public partial class DontShowDuplicatesInGetAuctionsStoredProcedure : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var sp = @"
                ALTER PROCEDURE GetAuctions
                ...
                BEGIN
                    ...
                    AND (auct.Deleted = 0) AND (auct.EndDate >= CONVERT(date, GETDATE()))
