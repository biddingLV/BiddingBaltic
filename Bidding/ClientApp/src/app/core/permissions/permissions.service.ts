...
import { IUserRolePermissions } from '../../models/user-role-permissions.model';
import { IAssignedPermission } from '../../models/assigned-permissions.model';
import { shareReplay, map, startWith, switchMap, mergeMap, flatMap } from 'rxjs/operators';
import { UserInfo } from '../../models/user-info.model';
import { Observable, timer, Subject } from 'rxjs';
import { IRoleFilter } from '../../../users/models/role-filter.model';
...
export class PermissionsService {
  private userRolePermissions$: Observable<IUserRolePermissions> = undefined;
